...
import com.nocteon.nocteon_api.common.exception.invalid.InvalidCategoryException;
...
public class CategoryService {
    ...
    @Transactional
    public CategoryResponse updateCategory(String slug, CategoryRequest request, MultipartFile image) {
    ...
    public List<CategoryResponse> getAllCategories() {
        String language = LocaleContextHolder.getLocale().getLanguage();
        return categoryRepository.findAllWithLanguage(language)
                .stream()
                .map(c -> buildResponse(c, language))
                .toList();
    }
